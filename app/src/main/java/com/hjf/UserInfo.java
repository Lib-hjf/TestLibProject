...
public class UserInfo implements Serializable {
	...
	/** 家庭信息 */
	public String home_id; // 家庭ID
	public String home_name; // 家庭名称
	public String home_icon; // 家庭图标
	public String home_sign; // 家庭签名
	...
	public JSONObject toJson() {
		...
		try {
			...
			json.put("home_name", home_name);
			json.put("home_icon", home_icon);
			json.put("home_sign", home_sign);
	...
	public static UserInfo fromJson(String json_str) {
		...
		try {
			...
			user.home_id = json.optString("home_id");
			user.home_name = json.optString("home_name");
			user.home_icon = json.optString("home_icon");
			user.home_sign = json.optString("home_sign");
	...
	public String toString() {
		String str = "[UserInfo user_id : " + user_id + ", user_name : " + name + " ,home_id :" + home_id
				+ " ,password :" + password;
		str += ", sign = " + sign;
		str += ", home_name = " + home_name + " , user_type = " + user_type;
